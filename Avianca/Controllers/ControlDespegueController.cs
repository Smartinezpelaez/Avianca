...
{
    public class ControlDespegueController : Controller
    {
        public ActionResult Index()
        {

            List<ControlDespegue> Control = new List<ControlDespegue>();

            var Vuelo1 = Services.AviancaServices.GetControlDespegue();
